...
public class FireballBowNetherItem extends Item {
    public FireballBowNetherItem() { super(new Item.Properties().durability(2031)); }
    ...
    public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
        fire(world, entityLiving, itemstack, 15.0D, 7, 1.5F);
    }
        ...
        if (!world.isClientSide && entityLiving instanceof ServerPlayer entity) {
            ...
            if (entity.getAbilities().instabuild || fireChargeStack != null) {
                ...
                FireballProjectileEntity fireball = new FireballProjectileEntity(
                    AngryBowEntities.FIREBALL_BOW_NETHER.get(),
                    entity,
