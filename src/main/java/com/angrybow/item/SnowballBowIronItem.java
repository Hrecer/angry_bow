...
public class SnowballBowIronItem extends Item {
	public SnowballBowIronItem() { super(new Item.Properties().durability(579)); }
	...
	@Override public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) { fire(world, entityLiving, itemstack, 10.5D, 5); }
	...
	private void fire(Level world, LivingEntity entityLiving, ItemStack itemstack, double damage, int knockback) {
		if (!world.isClientSide && entityLiving instanceof ServerPlayer entity) {
			...
			if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
				SnowballProjectileEntity projectile = SnowballProjectileEntity.shoot(AngryBowEntities.SNOWBALL_BOW_IRON.get(), world, entity, world.random, false, damage, knockback, 1.25F);
